...
#### Mac OS 
Send us an email at info@etsondemand.com for additional OS binaries.

### Create your First App

Let's begin by creating a Model.  Under "Home", click on "Manage Configurations"

![Configuration Menu](https://etsondemand.github.io/icmdmimages/applicationwelcome.PNG)   

 After the page loads, click "Add Configuration"
![Add Configuration](https://etsondemand.github.io/icmdmimages/manageconfigs.PNG)
      
 Enter a new name, say for example "Master Data"  
![Add Configuration](https://etsondemand.github.io/icmdmimages/newconfig.PNG)
...
![View Configuration](https://etsondemand.github.io/icmdmimages/listofconfigs.PNG)

 Click Edit, to view the Modeler window 
![View Model](https://etsondemand.github.io/icmdmimages/managemodeler.PNG)

 Click the Manage Model pen icon, to access the Application Configuration 
![View Application Config](https://etsondemand.github.io/icmdmimages/accessmodelerconfig.PNG)

 Click Glossary to add your first entity, Person & click Save 
![View Application Config](https://etsondemand.github.io/icmdmimages/addnewpersonentity.PNG)
...
![Person ID](https://etsondemand.github.io/icmdmimages/addnewcolumnpersonid.PNG)

![Person First Name](https://etsondemand.github.io/icmdmimages/addcolumnfirstname.PNG)

Click on Close to view the columns that you just created 
![View Columns](https://etsondemand.github.io/icmdmimages/viewcolumnslist.PNG)
...
Click on Rules
![View Rules](https://etsondemand.github.io/icmdmimages/accessrules.PNG)

Click on Match 
![Access Match Rules](https://etsondemand.github.io/icmdmimages/accessaddmatchgroup.PNG) 

Click on Add Match Group 
![Add Match Group](https://etsondemand.github.io/icmdmimages/addpersonmatchgroup.PNG) 

Click on the Match Group you just created 
![Access Match Group](https://etsondemand.github.io/icmdmimages/viewmatchgroupforperson.PNG) 

At this point, users can configure just one, or multiple match rules. The rules can be ranked based on priority 
![View Match Rules](https://etsondemand.github.io/icmdmimages/configurematchrules.PNG)
 
Select Match Rule on First Name, Exact Match. Assign this to a new rule id
![Configure new rule](https://etsondemand.github.io/icmdmimages/addnewmatchruleforpersongroup.PNG)
...
![Save and View Match Rules](https://etsondemand.github.io/icmdmimages/viewmatchrulesforpersongroup.PNG)

To add Cleanse rules, users must access the Rules Menu by clicking the back arrow on the popup screen. 
![View Rules](https://etsondemand.github.io/icmdmimages/accessrules.PNG)

Click on Cleanse 
![View Cleanse Group](https://etsondemand.github.io/icmdmimages/accesscleanserulegroup.PNG)

Add a cleanse group, CleansePerson 
![Configure new cleanse group](https://etsondemand.github.io/icmdmimages/cleansegroupcleanseperson.PNG)

 Click Save, to view the newly created Cleanse Groups
![Create cleanse groups](https://etsondemand.github.io/icmdmimages/listofcleansegroup.PNG)

 To Add additional cleanse rules to this group, click on the newly created cleanse group
![Create cleanse groups](https://etsondemand.github.io/icmdmimages/cleanseruleunderpersoncleansegroup.PNG)

 Add cleanse rule, and remove the extra space 
![Create cleanse rule a](https://etsondemand.github.io/icmdmimages/personcleanseremoveextraspace.PNG)

 Add another cleanse rule, replace character, replace Som to Sam
![Create cleanse rule b](https://etsondemand.github.io/icmdmimages/replaceSomtoSamcleanseruleforpersoncleansegroup.PNG)

View the newly added cleanse rules
![newly added cleanse rules](https://etsondemand.github.io/icmdmimages/addedcleanserulesundercleansepersongroup.PNG)
...
![view systems](https://etsondemand.github.io/icmdmimages/viewsystemsforreliability.PNG)
...
![view ranks](https://etsondemand.github.io/icmdmimages/viewranksforreliability.PNG)

 Click the back arrow again, to view the Rules Menu, now click on the Reliability Menu. 
![add reliability](https://etsondemand.github.io/icmdmimages/addreliability.PNG)

 To add new Reliability Rules, select the FirstName, System as MDM, and Rank as High
![add new reliabilty setting](https://etsondemand.github.io/icmdmimages/addnewreliabilitysetting.PNG)

 Click on Save to view the newly created Reliability Rule setting 
![add new reliabilty setting](https://etsondemand.github.io/icmdmimages/viewreliabilityrules.PNG)
...
![View UI Layout](https://etsondemand.github.io/icmdmimages/accessuilayout.PNG)

 Quickly access each section to ensure that Attributes are listed under each
![View Search UI Layout](https://etsondemand.github.io/icmdmimages/searchuiforperson.PNG)
...
![View New UI Layout](https://etsondemand.github.io/icmdmimages/newpersonuilayout.PNG)
...
![View Header UI Layout](https://etsondemand.github.io/icmdmimages/headerpersonuilayout.PNG)

### Deploy Application
Go to the Configuration Menu, by clicking the Home button, Then click the Manage Configuration menu.  
![Access Master Data Config](https://etsondemand.github.io/icmdmimages/accessmasterdataconfig.PNG) 
...
![Assign config to deployment](https://etsondemand.github.io/icmdmimages/assignconfigtodeploymentgroup.PNG) 

 Choose an unused deployment group, in this case we will pick, containerd.
![Assign config to deployment ii](https://etsondemand.github.io/icmdmimages/assignconfigtodeploymentgroup_ii.PNG) 

 Click Save and then press the Close button. Now this should look as follows  
![config assigned to deployment](https://etsondemand.github.io/icmdmimages/configassignedtodeploymentgroup.PNG)

 As a final step: pick the Deployment Group and hit Deploy 
![deploy config to deployment group](https://etsondemand.github.io/icmdmimages/beforedeployment.PNG)

 This will create a database and move your configurations into the respective schema. 
![view ui links under deployment](https://etsondemand.github.io/icmdmimages/afterdeployment.PNG)
...
![accessing mdm application](https://etsondemand.github.io/icmdmimages/mdmapplicationentry.PNG)
...
![accessing mdm application ii](https://etsondemand.github.io/icmdmimages/mdmapplicationentry.PNG)
...
![search person](https://etsondemand.github.io/icmdmimages/searchperson.PNG)

The screen should look as follows 
![add new person](https://etsondemand.github.io/icmdmimages/addnewperson.PNG)

Let's create a record, with First Name as Som Matthew 

![add new person sam matt](https://etsondemand.github.io/icmdmimages/addnewpersonsommatt.PNG) 

& Click Save 
![sam matt created](https://etsondemand.github.io/icmdmimages/sommattcreated.PNG) 
...
![second sam matt](https://etsondemand.github.io/icmdmimages/sammatthewii.PNG)
...
![Same Matt Cross ref](https://etsondemand.github.io/icmdmimages/sammatthewcrossref.PNG)
...
![header menu](https://etsondemand.github.io/icmdmimages/sommattcreated.PNG) 
...
![Data Stores](https://etsondemand.github.io/icmdmimages/datastoreslist.PNG) 
...
![Target DS](https://etsondemand.github.io/icmdmimages/masterdatatarget.PNG)

Source Data Store 

![Source DS](https://etsondemand.github.io/icmdmimages/importexcelfile.PNG) 
...
![Data flow pipeline](https://etsondemand.github.io/icmdmimages/dataflowpipelines.PNG)   

Access a Sample Data Flow Pipeline instance 
![Data flow pipeline inst ](https://etsondemand.github.io/icmdmimages/dataflowipeline_inst.PNG)
 ...
 ![Hover on db](https://etsondemand.github.io/icmdmimages/hoverondb.PNG) 
 ...
 ![Hover on db](https://etsondemand.github.io/icmdmimages/dsproperties.PNG) 
 ...
 ![Extract stage prop](https://etsondemand.github.io/icmdmimages/extractproperties.PNG) 
...
![Transform stage prop](https://etsondemand.github.io/icmdmimages/transformstageproperties.PNG) 
...
![Load store prop](https://etsondemand.github.io/icmdmimages/loadstoreproperties.PNG)
...
### Product Download 
[click to goto iclassicmdm download page](https://www.etsondemand.com/downloadicmdm.html) 

### Support or Contact
 
For further questions please email us at info@etsondemand.com . 
